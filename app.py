        ...
        if nova == nova_copia:
            if vella == contra_Actual:
                if nova != vella:
                    ...
                    restablir_contra.errorcontra.setText("La contrasenya nova no pot ser igual a la que tenies")
                    restablir_contra.errorcontra.setStyleSheet("color: rgb(255, 0, 0);")
            else:
                restablir_contra.errorcontra.setText("La contrasenya vella no es igual a la que tenies")
                restablir_contra.errorcontra.setStyleSheet("color: rgb(255, 0, 0);")
            

        else:
            restablir_contra.errorcontra.setText("Contrasenyes no coincideixen")
            restablir_contra.errorcontra.setStyleSheet("color: rgb(255, 0, 0);")
